...
@IBDesignable open class BetterSegmentedControl: UIControl {
    ...
    /// Радиус углов элемента управления и индикатора.
    ...
    /// Внутренний отступ виджета индикатора. По умолчанию `2.0`.
    ...
    /// Ширина границы виджета индикатора.
    ...
    /// Цвет границы виджета индикатора.
